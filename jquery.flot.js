...
(function($) {
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function parseOptions(opts) {
            ...
            if (options.grid.borderColor && typeof options.grid.borderColor != "object") {
        ...
        function allocateAxisBoxFirstPhase(axis) {
            ...
            if (axis.direction == "x") {
                ...
                if (pos == "bottom") {
                    ...
                    axis.box.top = canvasHeight - (plotOffset.bottom - bw.bottom);
                }
                else {
                    axis.box.top = (plotOffset.top - bw.top);
                ...
                if (pos == "left") {
                    axis.box.left = (plotOffset.left - bw.left);
                    plotOffset.left += axis.box.width;
                }
                else {
                    plotOffset.right += axis.box.width;
                    axis.box.left = canvasWidth - (plotOffset.right - bw.right);
                }
            }
