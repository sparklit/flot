...
to disable the border. Set it to an object with "top", "right", "bottom"
and "left" properties to have different widths on each side. You can 
also set "borderColor" if you want the border to have a different color 
than the grid lines. Set it as an object with "top", "right", "bottom"
and "left" properties to have different colors on each side. 
